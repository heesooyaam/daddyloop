...
`/defaults` задаёт модели для новых задач, `/models` меняет выбранную задачу. Модель и reasoning effort выбираются **отдельно для автора и ревьюера** из каталога твоего аккаунта Codex.
