...
Сессии из CLI и с сайта тоже получают свои темы. Вопросы, промежуточные реплики и ответы идут в один разговор с подписями `[user]` и `[daddy]`; логи инструментов туда не попадают.
...
| Личные уведомления об итогах и вопросах | `/notifications` → тихий режим       |
...
Удачные наборы сохраняй в **Пресеты**: для сессии можно включить несколько и отметить нужные компоненты внутри каждого. Библиотека и выбор сессий входят в бекап. В браузере также можно выбрать папку устройства и загрузить из неё нужные файлы инструкций.
...
[Релиз 0.20.1](https://github.com/heesooyaam/daddyloop/releases/tag/v0.20.1) · [CI](https://github.com/heesooyaam/daddyloop/actions)
